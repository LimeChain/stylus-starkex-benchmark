...
//     fn fri_verify_layers(&self, ctx: &mut Vec<U256>, proof: &Vec<U256>, fri_step_sizes: &Vec<U256>) -> Result<(), Vec<u8>> {
...
//     fn compute_last_layer_hash(proof: &Vec<U256>, ctx: &mut Vec<U256>, n_points: usize, sum_of_step_sizes: U256) -> Result<U256, Vec<u8>> {
...
//     fn horner_eval(proof: &Vec<U256>, coefs_start: usize, point: U256, n_coefs: usize) -> Result<U256, Vec<u8>> {

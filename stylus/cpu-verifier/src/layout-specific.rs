...
impl LayoutSpecific {
    ...
    pub fn get_layout_info(&self) -> (U256, U256) {
    ...
    pub fn layout_specific_init(ctx: &mut [U256], public_input: &[U256]) -> Result<(), Vec<u8>> {
    ...
    pub fn prepare_for_oods_check(ctx: &mut [U256]) -> Result<(), Vec<u8>> {
...
mod tests {
    ...
    fn test_layout_specific_init() {
        ...
        try_execute!(LayoutSpecific::layout_specific_init(&mut ctx, &public_input));

...
impl ConstraintPoly {
    ...
    pub fn composition_polynomial(
        ...
        let sum_7_8_9 = result[9]
            ...
            .add_mod(result[7], PRIME);
        result.push(U256::from(1).add_mod(PRIME.wrapping_sub(sum_7_8_9), PRIME));
        ...
        result.push(U256::from(1).add_mod(PRIME.wrapping_sub(sum_12_13), PRIME));
...
mod test {
    ...
    fn test_composition_polynomial() {
        let result = ConstraintPoly::composition_polynomial(&INPUT, &DOMAINS, &DEN_INV).unwrap();
